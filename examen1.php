...
<section class="programa">
    <div class="contenedor-contenido2">
    </div>
    <div class="contenido-programa">
        <div class="contenedor">
        <h2>Multiplicación de números naturales</h2>
            ...
            <form id="registro" class="registro" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF'])?>" method="post">
                ...
                <div id="datos_usuario" class="registro caja clearfix">
                     <div class="campo">
                     <label for="preg1"><h3>¿Cuánto es 4 X 4?</h3></label>
                    ...
                    <div class="radio">
                        <h3>¿Cuánto es 8 X 9? (Selecciona una respuesta)</h3>
